...
para la migración del Centro Gallego a Software libre. 3 presupuestos:
Gcoop, OpenSA y Coletti
...
Se actuo como puente entre el equipo de Oscar y el equipo tecnico del INAES
destrabando en dias situaciones que estaban frenando el trabajo desde
semanas.

Se recomendo la implementación de sistemas recomendados en el INAES para
mejorar la productividad (Gestor de incidentes) y se facilito su transición
al centro.

Se identificó y acompaño la instalación de Software Libre para enquestas a
pedido de Noelia Carrizo en destaque al Centro Gallego, evitando la compra
de Software costoso (o peor su uso de manera ilegal).
