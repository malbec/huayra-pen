...
Software Libre que cubre el soporte interno de INAES tanto como el Sector Cooperativo / PyME desde donde se establecieron
vinculos y buenas practicas. Todos las soluciones desarrolladas desde este
espacio se encuentran en repositorios públicos.
...
*** Instalación y configuración de un sistema para geo referencia (Por ejemplo para rehalizar el mapeo de los cortes de luz)
*** Prueba piloto de migración a Software Libre en el área de promoción
